...
from .views import CallLogListCreateView, CallLogDetailView, CallStatsView, TwimlVoiceView, CallTransferView
...
urlpatterns = [
    ...
    path('transfer/', CallTransferView.as_view(), name='call-transfer'),
